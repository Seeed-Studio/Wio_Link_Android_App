 ...
 */
public class NodeListRecyclerAdapter_backup extends RecyclerView.Adapter<NodeListRecyclerAdapter_backup.MainViewHolder> {
    ...
    public NodeListRecyclerAdapter_backup(ArrayList<Node> nodes) {
        this.nodes = nodes;
    }
